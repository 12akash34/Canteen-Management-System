...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="edit_food_items.css">
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    $query = mysqli_query($conn, "SELECT * FROM FOOD f WHERE f.options = 'ENABLE' AND f.R_ID IN (SELECT c.R_ID FROM CANTEENS c WHERE c.M_ID='$user_check') ORDER BY F_ID");
