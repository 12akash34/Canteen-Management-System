...
<div class="container">
    <div class="row">
    	...
    	<div class="list-group">
    		<a href="mycanteen.php" class="list-group-item active">My Canteen</a>
    		<a href="view_food_items.php" class="list-group-item ">View Food Items</a>
    		<a href="add_food_items.php" class="list-group-item ">Add Food Items</a>
    		<a href="edit_food_items.php" class="list-group-item ">Edit Food Items</a>
    		<a href="delete_food_items.php" class="list-group-item ">Delete Food Items</a>
    		<a href="view_order_details.php" class="list-group-item ">View Order Details</a>
    		<a href="top_up_wallet.php" class="list-group-item ">Top Up Wallet</a>
    ...
    <div class="col-12 col-sm-8 col-md-6">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> ADD CANTEEN</h3>

          <div class="form-group">
            <input type="text" class="form-control" id="name" name="name" placeholder="Your Canteen's Name" required="">
          </div>
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="address" name="address" placeholder="Your Canteen's Block in Institute" required="">
          </div>

          <div class="form-group">
          <button type="submit" id="submit" name="submit" onclick="display_alert1()" class="btn btn-primary pull-right"> ADD CANTEEN </button>    
      </div>
        </form>
    ...
    <div class="col col-sm-4 col-md-6">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> YOUR CANTEENS </h3>
...
$sql = "SELECT * FROM CANTEENS c WHERE c.R_ID IN (SELECT c.R_ID FROM CANTEENS c WHERE c.M_ID='$user_check') ORDER BY R_ID";
