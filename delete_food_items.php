...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="delete_food_items.css">
...
$sql = "SELECT * FROM FOOD f WHERE f.options = 'ENABLE' AND f.R_ID IN (SELECT c.R_ID FROM CANTEENS c WHERE c.M_ID='$user_check') ORDER BY F_ID";
