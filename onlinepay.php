...
<html>
  ...
  <head>
    ...
    <title> Online Payment | v-Lounge </title>
...
<ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fa fa-log-in"></span> Login <span class="caret"></span></a>
              <ul class="dropdown-menu">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                              <a href="bill.php"><input type="submit" class="btn btn-success btn-block" value="PAY NOW" required="" /></a>  
                            </div>
                        </div>
